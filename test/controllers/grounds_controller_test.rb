...
class GroundsControllerTest < ActionController::TestCase
  ...
  test "should create ground" do
    assert_difference('Ground.count') do
      post :create, ground: { close_time: @ground.close_time, open_time: @ground.open_time, sport: @ground.sport }
    end
  ...
  test "should update ground" do
    patch :update, id: @ground, ground: { close_time: @ground.close_time, open_time: @ground.open_time, sport: @ground.sport }
    assert_redirected_to ground_path(assigns(:ground))
  end
